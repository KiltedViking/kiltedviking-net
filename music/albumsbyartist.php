...
<html>
  ...
  <title>My Music (Kilted Viking)</title>
            ...
            <tr>
              <td width="150" class="menucolumn">
                ...
                <table width="100%">
                  ...
                  <tr>
                    <td class="menuitem"><a href="./" class="menuitem">&lt;&lt; Back to My Music</a></td>
                  </tr>
                  <tr>
...
if($link)
{
  ...
  $strSql = "SELECT artist, title, released, media FROM albums ORDER BY artist, released, title";
